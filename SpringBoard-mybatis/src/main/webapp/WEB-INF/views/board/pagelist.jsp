	...
	<div id="container">
	    <section id="boardlist">
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="/board/paging?page=${1}"><i class="fa-solid fa-forward fa-rotate-180"></i></a>
					<a href="/board/paging?page=${paging.page - 1}"><i class="fa-solid fa-play fa-rotate-180"></i></a>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="/board/paging?page=${paging.page + 1}"><i class="fa-solid fa-play"></i></a>
					<a href="/board/paging?page=${paging.maxPage}"><i class="fa-solid fa-forward"></i></a>
				</c:otherwise>
			</c:choose>
			</div>
